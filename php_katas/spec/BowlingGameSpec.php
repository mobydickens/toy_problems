...
class BowlingGameSpec extends ObjectBehavior
{
  ...
  function it_scores_the_sum_of_all_knocked_down_pins_for_game()
  {
    $this->rollTimes(20,1);
  ...
  function it_takes_exception_with_invalid_roll()
  {
  ...
  // extract functions to make code more readable in tests as well (specific rules)
